...
async function createCitiesTable() {
  try {
    console.log('🏗️ Création de la table cities...');
...
async function importCitiesToDatabase(cities) {
  try {
    console.log('💾 Import des communes dans la base de données...');
    ...
    console.log(`✅ ${insertedCount} communes importées avec succès`);
...
async function verifyImport() {
  try {
    ...
    console.log(`📊 Total des communes dans la base: ${total}`);
...
async function main() {
  try {
    console.log('🚀 Début de l\'import des communes françaises...');
